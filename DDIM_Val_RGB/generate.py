...
def parse_option():
    ...
    parser.add_argument("-cp", "--checkpoint_path", type=str, default='./checkpoint/costum_map_20'
                                                                      '.pth')
    ...
    parser.add_argument("-sp", "--image_save_path", type=str, default='./data/generate_map_1')
